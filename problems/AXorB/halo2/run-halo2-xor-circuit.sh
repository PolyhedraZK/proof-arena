...
# build rust binaries
cd problems/AXorBpw/halo2/ && cargo build --release -p halo2_xor_circuit && cd -
...
problems/AXorB/SPJ/SPJ -cpu 16 -largestN 10919 \
  ...
  -prover "problems/AXorBpw/halo2/target/release/prover" \
  -verifier "problems/AXorBpw/halo2/target/release/verifier"
