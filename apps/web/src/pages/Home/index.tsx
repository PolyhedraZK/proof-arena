        ...
        <section className={styles.section}>
          ...
          <div className={styles.cardContainer}>
            <Card title="ZK Prover Track" className={styles.card}>
              Benchmark various ZK proving systems on standard cryptographic
              problems.
            </Card>
            <Card title="zkVM Track" className={styles.card}>
              Test and compare different Zero-Knowledge Virtual Machines on
              computational tasks.
            </Card>
            <Card title="Open Contribution" className={styles.card}>
              Submit new problems or contribute solutions to existing
              challenges.
            </Card>
          </div>
        </section>
